...
const MANAGED_ENV_KEYS = ["TYPESAFE_API_KEY", "JEV_TRIAGE_DISABLED", "JEV_DECISION_LOG"] as const;

/** Clear Jev-related environment variables around every test in the file. */
